...
import br.com.meuprojeto.data.vo.v1.security.AccountCredentialsVO;
...
import br.com.meuprojeto.integrationtests.vo.wrappers.WrapperBookVO;
...
public class BookControllerJsonTest extends AbstractIntegrationTest{
	...
	public void testUpdate() throws JsonMappingException, JsonProcessingException {
	    ...
	    public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
	      ...
	      // assertTrue(content.contains("{\"prev\":{\"href\":\"http://localhost:8888/api/book/v1?limit=4&direction=asc&page=0&size=4&sort=title,asc\"}"));
